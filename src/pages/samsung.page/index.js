import bannerSamsung1 from "../../images/banner-samsung-1.webp";
import bannerSamsung2 from "../../images/banner-samsung-2.webp";
                    ...
                    <div className="row">
                        <div className="col-6">
                            <div className="page-banner">
                                <img src={bannerSamsung1} />
                            </div>
                        </div>
                        <div className="col-6">
                            <div className="page-banner">
                                <img src={bannerSamsung2} />
                            </div>
                        </div>
                    </div>
                    <div className="page-title mt-40">
                        <div className="page-name">Tất cả sản phẩm <span>SamSung</span></div>
